...
Javadoc: [tiny.cc/ftcjava](http://tiny.cc/ftcjava)
...
- The robot controller cannot detect USB devices
  ...
  - If your setup is correct, do a full power cycle and disconnect all devices. Suggested order for powering on the robot: 
    -  1) Phone on, no apps running 
    -  2) Plug in power distribution module 
    -  3) Turn on power distribution module, allowing the phone to launch the robot controller app automatically.
