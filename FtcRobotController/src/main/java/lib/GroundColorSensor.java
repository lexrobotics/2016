 ...
 *
 */
public class GroundColorSensor extends ColorSensor implements I2cController.I2cPortReadyCallback {
    ...
    public GroundColorSensor(DeviceInterfaceModule deviceInterfaceModule, int physicalPort) {
